 ...
 * @author andyv
 */
public class PMarcaA extends javax.swing.JFrame {
   ...
   private DefaultTableModel dtm=new DefaultTableModel();
    ...
    private void MostarTable(){
        dtm.setColumnIdentifiers(new String[]{"Codigo","Nombre","Estado"});
     ...
     Marca mar=new Marca();
     int est=0;
     if(!txtCodigo.getText().isEmpty()){mar.setCodigo(Integer.parseInt(txtCodigo.getText()));}
     mar.setNombre(txtNombre.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PMarcaA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

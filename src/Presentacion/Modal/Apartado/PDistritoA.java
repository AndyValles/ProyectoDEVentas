 ...
 * @author andyv
 */
public class PDistritoA extends javax.swing.JFrame {
     private NDistrito dd=new NDistrito(); 
     private DefaultTableModel dtm=new DefaultTableModel();
     private int datos;
     
     public static int ClienteDist=1;
     public static int TrabajadorDis=1;
             
     public PDistritoA(int Datos){
         this.datos=Datos;
         Inicio();
     }
    ...
    this.setLocationRelativeTo(this);
     ...
     private Distrito Items(){
     Distrito dis=new Distrito();
     int est=0;
     if(!txtCodigo.getText().isEmpty()){dis.setCodigo(Integer.parseInt(txtCodigo.getText()));}
    ...
    private void initComponents() {
        ...
        panelRound1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PDistritoA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PDistritoA().setVisible(true);
            }
        });
    }

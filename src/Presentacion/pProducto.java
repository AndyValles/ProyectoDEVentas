...
public class pProducto extends javax.swing.JFrame {
    ...
    private void MostarTable(){
        dtm.setColumnIdentifiers(new String[]{"Codigo","Descripcion","Precio","Stock","Categoria","Marca","Estado"});
    ...
    private Producto Codigo(){
        Producto pp=new Producto(); 
           if(!txtCodigo.getText().isEmpty())
            ...
            JOptionPane.showMessageDialog(rootPane,"Por favor ingresar codigo");
    ...
    private void initComponents() {
        ...
        lProducto.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lProducto.setForeground(new java.awt.Color(255, 0, 0));
        ...
        panelRound3.setBackground(new java.awt.Color(21, 23, 36));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        this.dispose();
            new PProductoA(Codigo()).setVisible(true);
